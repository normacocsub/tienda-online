  ...
  return (
    <LayoutUser>
      <div className={styles.content}>
        <h1 style={{ fontSize: 24 }}>Registro Usuario</h1>
        <Form
          {...formItemLayout}
        ...
        >
          <Form.Item
            ...
            name={'cedula'}
            rules={[
              { required: true, message: 'Por favor completa la cedula' },
          ...
          <Form.Item
            ...
            name={'nombre'}
            rules={[
              { required: true, message: 'Por favor completa el nombre' },
              {
                pattern: /^[A-Za-z]+$/,
          ...
          <Form.Item
            ...
            name={'apellido'}
            rules={[
              { required: true, message: 'Por favor completa el apellido' },
            ...
            rules={[
              {
                validator: (_, value) => {
                  ...
                  if (!regex.test(value)) {
                    return Promise.reject(
                      'Ingrese un número de celular válido, debe contener 10 caracteres'
                    );
                  }
                  return Promise.resolve();
                },
          ...
          <Form.Item
            ...
            name={'correo'}
            rules={[
              { required: true, message: 'Por favor completa el correo' },
          ...
          <Form.Item
            ...
            name={'password'}
            rules={[
              { required: true, message: 'Por favor completa la contraseña' },
